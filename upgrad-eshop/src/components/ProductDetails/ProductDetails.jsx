...
import { Chip, TextField, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material";
import axios from "axios";
import NavigationBar from "../../common/NavBar/NavBar";
import PlaceOrderButtonMui from "../../common/MuiComponents/Buttons/PlaceOrderButtonMui";
  ...
  useEffect(() => {
    if (authToken !== null) {
      axios
        ...
        .catch(function () {
          ErrorToast(
            "Error observed: There was an issue in retrieving categories list."
          );
        });
      axios
        ...
        .catch(() =>
          ErrorToast(
            "Error observed: There was an issue in fetching the product details."
          )
        );
    } else {
      navigate("/login");
