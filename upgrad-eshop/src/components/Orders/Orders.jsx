...
const steps = ["Items Selected", "Select The Address", "Confirm Order"];
  ...
  const handleAddressSubmit = (event) => {
    ...
    if (name && street && city && stateName && zipCode && contactNumber) {
      ...
      axios
        ...
        .catch(() =>
        ErrorToast(
          "There was an issue in saving the address. Please provide correct details in order to proceed."
          )
        );
    }
  };
